...
```
    ...
    ## # A tibble: 50,400 x 6
    ##     week day_id day    minute activity_counts weekday_or_weekend
    ##    <dbl>  <dbl> <fct>   <dbl>           <dbl> <chr>             
    ##  1     1      4 Sunday      1               1 weekend           
    ##  2     1      4 Sunday      2               1 weekend           
    ##  3     1      4 Sunday      3               1 weekend           
    ##  4     1      4 Sunday      4               1 weekend           
    ##  5     1      4 Sunday      5               1 weekend           
    ##  6     1      4 Sunday      6               1 weekend           
    ##  7     1      4 Sunday      7               1 weekend           
    ##  8     1      4 Sunday      8               1 weekend           
    ##  9     1      4 Sunday      9               1 weekend           
    ## 10     1      4 Sunday     10               1 weekend           
